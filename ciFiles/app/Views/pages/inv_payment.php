...
$payment_data = json_decode($invoice["payment_data"],TRUE); 
$customer_data = json_decode($invoice["customer_data"],TRUE); ?> 
<main role="main" class="page-content">
    <?php $dateStrToTime = strtotime($invoice["validity"]); $dateExpiry = date("d-m-Y",$dateStrToTime); 
    if(strtotime(date("d-m-Y"))<strtotime($dateExpiry)||$dateExpiry=="NA"): ?>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-12 col-sm-12">
                <div class="card">
                    <div class="card-body"> 
                        <h3>Payment Data</h3><h6><strong>Amount:</strong> <?php echo $invoice["currency"].' '.$invoice["amount"]; ?></h6><h6><strong>Purpose:</strong> <?php echo $payment_data["product_service"]; ?></h6></div></div><br><br><div class="card"><div class="card-body"><h3>Your Data</h3>
    ...
    <?php else: ?>
        ...
        <h4 Ppaclass="text-center">Invoice Expired</h4>
...
<script>
    ...
    "currency":"<?php echo $order["currency"]; ?>","name":"<?php echo $user["bname"]; ?>",
    "description":"<?php echo $payment_data["product_service"]; ?>",
